...
train_path=/data/user2/tmp/CONE/data/ego4d_nlq_data_for_cone/data/ego4d_data/train_v1.jsonl
eval_path=/data/user2/tmp/CONE/data/ego4d_nlq_data_for_cone/data/ego4d_data/val.jsonl
eval_split_name=val

######## Setup video/textual feature path, need to replace them based on your directory
motion_feat_dir=/data/user2/tmp/CONE/data/ego4d_nlq_data_for_cone/offline_lmdb/egovlp_video_feature_1.87fps
appearance_feat_dir=/data/user2/tmp/CONE/data/ego4d_nlq_data_for_cone/offline_lmdb/egovlp_video_feature_1.87fps
text_feat_dir=/data/user2/tmp/CONE/data/ego4d_nlq_data_for_cone/offline_lmdb/egovlp_egovlp_text_features
